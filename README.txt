...
1) install cygwing with wget only
...
Install Java to run toolsUI-5.4.1.jar
...
2) Create virtual environment: conda create -n Tarawa_EWS python=3.9.4 spyder=5.0.3
3) conda activate Tarawa_EWS
